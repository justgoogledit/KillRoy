...
- Not for AMR/fleet data -- this skill only touches mail, Teams, Planner, and Loop. The Planner digest already in [[Skills/run-daily-workflow/SKILL|run-daily-workflow]] covers that ground; fleet questions go to the `overmind` MCP.
