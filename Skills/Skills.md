...
- [[Skills/check-connectors/SKILL|check-connectors]] -- verify `.env` and all three data sources are reachable before any workflow skill runs.
...
- [[Skills/run-daily-workflow/SKILL|run-daily-workflow]] -- day runner: morning brief, midday delta, end-of-day close-out and carry-overs. Orchestrates the two skills above. Runs proactively on a schedule.
